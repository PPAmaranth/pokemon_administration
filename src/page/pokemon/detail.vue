<template>
  <div>
    <el-collapse v-model="pokemonDetailState.activeNames">
      ...
      <el-collapse-item title="能力值" name="2">
        <el-row :gutter="24" justify="space-between">
          <el-col :span="8">
...
export default {
  ...
  computed:{
      pokemonDetailState:{
          get:function(){
              return this.$store.getters["main/pokemon/pokemon_detail/getPokemonDetailState"]
          },
          set:function(val){
              return val
          }
